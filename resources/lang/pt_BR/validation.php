...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'client.type' => 'tipo da pessoa',
        'client.document' => 'documento',
        'client.name' => 'nome',
        'client.legal_name' => 'razão social',
        'client.email' => 'e-mail',
        ...
        'pipeline_status_id' => 'pipeline Status',
        'name' => 'nome',
        'value' => 'valor',
        ...
        'client_id' => 'cliente',
        'owner_id' => 'dono',
        'finished_status' => 'status efetivada',
        'finished_date' => 'data efetivada',
        'finished_value' => 'valor efetivada',
        'insurance_company_id' => 'seguradora efetivada',
        'deal_lost_reason_id' => 'motivo perda',
        'finished_observation' => 'observação fechamento',
