...
import { defaultPersonContact, LOCALE } from "../../../constants";
import DefaultInput from "../../inputs/DefaultInput";

export default function QuotationDocumentForm(props) {
    ...
    useEffect(() => {
        if (props.id) {
            ...
            setLoading(false);
            setObject({ ...defaultPersonContact, quotation_id: props.quotationId });
        }
    }, [props.id]);
    ...
    const handleSave = () => {
        ...
        formData.set("quotation_id", props.quotationId);
        ...
        axios({
            url: `/api/quotation-documents${props.id ? `/${props.id}` : ""}`,
