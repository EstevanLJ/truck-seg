...
export default function DealDocuments({ documents, reload, deal }) {
    ...
    const handleDeleteDialogConfirm = () => {
        axios
            .delete(`/api/deal-documents/${deletingObject.id}`)
            .then((response) => {
    ...
    const columns = [
        ...
        { id: "user.name", label: LOCALE.user, format: (value, row) => row.user.name },
        {
            id: "actions",
