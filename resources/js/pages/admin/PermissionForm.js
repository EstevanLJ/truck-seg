...
export default function PermissionForm(props) {
    ...
    const handleSave = () => {
        ...
        axios({
            url: `/api/permissions${props.id ? `/${props.id}` : ""}`,
        ...
        <div className="p-4 w-screen sm:w-3/4-screen lg:w-1/2-screen">
            <div className="flex justify-between items-center">
                <p className="font-bold">
                    {props.id ? LOCALE.edit : LOCALE.add} Permissão
                </p>
