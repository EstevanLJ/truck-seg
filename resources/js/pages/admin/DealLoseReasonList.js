...
import DealLoseReasonForm from "./DealLoseReasonForm";
import { LOCALE } from "../../constants";

export default function DealLoseReasonList() {
    ...
    const handleDeleteDialogConfirm = () => {
        setLoading(true);
        axios
            .delete(`/api/deal-lost-reasons/${showDeleteDialog}`)
            .then((response) => {
